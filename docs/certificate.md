...
`jomrr.ca.certificate` is the single-certificate public module. The role tasks use
`jomrr.ca.certificate_batch` for `ca_certificates`; both modules use the same
