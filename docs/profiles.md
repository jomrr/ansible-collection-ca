...
`plugins/module_utils/_profiles.py` is not an Ansible module. It contains the built-in
certificate profile defaults used by [`jomrr.ca.certificate`](certificate.md).
